...
void NfcFilterUpdate1(NfcFilter *nfc, ALfloat *dst, const float *src, const int count)
{
...
void NfcFilterUpdate2(NfcFilter *nfc, ALfloat *dst, const float *src, const int count)
{
    const float b0 = nfc->coeffs[0];
...
void NfcFilterUpdate3(NfcFilter *nfc, ALfloat *dst, const float *src, const int count)
{
    const float b0 = nfc->coeffs[0];
    const float a00 = nfc->coeffs[1];
    const float a01 = nfc->coeffs[2];
