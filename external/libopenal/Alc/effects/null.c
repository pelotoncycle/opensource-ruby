...
static ALvoid ALnullState_process(ALnullState *state, ALuint samplesToDo, const ALfloatBUFFERSIZE*samplesIn, ALfloatBUFFERSIZE*samplesOut, ALuint NumChannels);
 ...
 * not replace it.
 */
static ALvoid ALnullState_process(ALnullState* UNUSED(state), ALuint UNUSED(samplesToDo), const ALfloatBUFFERSIZE*UNUSED(samplesIn), ALfloatBUFFERSIZE*UNUSED(samplesOut), ALuint UNUSED(NumChannels))
{
}
