...
static ALvoid ALreverbState_process(ALreverbState *State, ALuint SamplesToDo, const ALfloat (*SamplesIn)[BUFFERSIZE], ALfloat (*SamplesOut)[BUFFERSIZE], ALuint NumChannels);
...
static ALvoid ALreverbState_update(ALreverbState *State, const ALCdevice *Device, const ALeffectslot *Slot, const ALeffectProps *props)
{
    ...
    /* the filter gains from going below -40dB to keep the I3DL2
...
static void CalcModulationDelays(ALreverbState *State, ALfloat *delays, const ALsizei todo)
{
    ALfloat sinus, range;
    ALsizei index, i;
 ...
 * reverb.
 */
static void EAXModulation(DelayLine *ModDelay, ALsizei offset, const ALfloat *delays, ALfloat*dst, const ALfloat*src, const ALsizei todo)
{
    ALfloat frac, fdelay;
    ALfloat out0, out1;
    ALsizei delay, i;
