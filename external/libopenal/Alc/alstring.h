...
extern void alstr_reset(al_string *str);
extern size_t alstr_length(const_al_string str);
extern ALboolean alstr_empty(const_al_string str);
extern const al_string_char_type *alstr_get_cstr(const_al_string str);
