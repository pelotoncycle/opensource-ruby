...
static void allpass_process(AllPassState *state, ALfloat *dst, const ALfloat *src, const ALfloat aa, ALsizei todo)
{
    ALsizei i;
...
void EncodeUhj2(Uhj2Encoder *enc, ALfloat *LeftOut, ALfloat *RightOut, ALfloat (*InSamples)[BUFFERSIZE], ALsizei SamplesToDo)
{
