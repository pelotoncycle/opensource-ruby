...
static const struct {
    ...
    DECL(AL_EQUALIZER_MID0_GAIN),
	DECL(AL_EQUALIZER_MID0_CENTER),
	DECL(AL_EQUALIZER_MID0_WIDTH),
	DECL(AL_EQUALIZER_MID1_GAIN),
	DECL(AL_EQUALIZER_MID1_CENTER),
	DECL(AL_EQUALIZER_MID1_WIDTH),
	DECL(AL_EQUALIZER_MID2_GAIN),
	DECL(AL_EQUALIZER_MID2_CENTER),
	DECL(AL_EQUALIZER_MID2_WIDTH),
	DECL(AL_EQUALIZER_MID3_GAIN),
	DECL(AL_EQUALIZER_MID3_CENTER),
	DECL(AL_EQUALIZER_MID3_WIDTH),
	/*****************************/
	DECL(AL_EQUALIZER_MID4_GAIN),
	DECL(AL_EQUALIZER_MID4_CENTER),
	DECL(AL_EQUALIZER_MID4_WIDTH),
	DECL(AL_EQUALIZER_MID5_GAIN),
	DECL(AL_EQUALIZER_MID5_CENTER),
	DECL(AL_EQUALIZER_MID5_WIDTH),
	DECL(AL_EQUALIZER_MID6_GAIN),
	DECL(AL_EQUALIZER_MID6_CENTER),
	DECL(AL_EQUALIZER_MID6_WIDTH),
	DECL(AL_EQUALIZER_MID7_GAIN),
	DECL(AL_EQUALIZER_MID7_CENTER),
	DECL(AL_EQUALIZER_MID7_WIDTH),
...
#undef TRACE_ATTR
    ...
    if(device->RealOut.NumChannels != 0)
        device->RealOut.Buffer = device->Dry.Buffer + device->Dry.NumChannels + device->FOAOut.NumChannels;
    else
    {
...
ALC_API ALCdevice* ALC_APIENTRY alcOpenDevice(const ALCchar *deviceName)
{
    ...
    //device->NumUpdates = 3;	//by stone
    //device->UpdateSize = 1024;
    device->NumUpdates = 4;
    device->UpdateSize = 128;		//fit for MAX_UPDATE_SAMPLES
