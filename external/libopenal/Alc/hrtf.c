...
ALsizei BuildBFormatHrtf(const struct Hrtf *Hrtf, DirectHrtfState *state, ALsizei NumChannels, const ALfloat (*AmbiPoints)[2], const ALfloat (*AmbiMatrix)[2][MAX_AMBI_COEFFS], ALsizei AmbiCount)
{
...
vector_EnumeratedHrtf EnumerateHrtf(const_al_string devname)
{
    ...
    al_string 	hstr[2];
	char*		table[2] =  {	"/system/media/audio/default-44100.mhr",
										"/system/media/audio/default-48000.mhr" };
