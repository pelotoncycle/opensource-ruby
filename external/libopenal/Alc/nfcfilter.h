...
void NfcFilterUpdate1(NfcFilter *nfc, float *dst, const float *src, const int count);
...
void NfcFilterUpdate2(NfcFilter *nfc, float *dst, const float *src, const int count);
...
void NfcFilterUpdate3(NfcFilter *nfc, float *dst, const float *src, const int count);
