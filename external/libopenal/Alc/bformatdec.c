...
void bandsplit_process(BandSplitter *splitter, ALfloat *hpout, ALfloat *lpout,
...
void bformatdec_process(struct BFormatDec *dec, ALfloat (*OutBuffer)[BUFFERSIZE], ALsizei OutChannels, const ALfloat (*InSamples)[BUFFERSIZE], ALsizei SamplesToDo)
{
    ALsizei chan, i;
...
void bformatdec_upSample(struct BFormatDec *dec, ALfloat (*OutBuffer)[BUFFERSIZE], const ALfloat (*InSamples)[BUFFERSIZE], ALsizei InChannels, ALsizei SamplesToDo)
{
    ALsizei i;
...
void ambiup_process(struct AmbiUpsampler *ambiup, ALfloat (*OutBuffer)[BUFFERSIZE], ALsizei OutChannels, const ALfloat (*InSamples)[BUFFERSIZE], ALsizei SamplesToDo)
{
    ALsizei i, j;
