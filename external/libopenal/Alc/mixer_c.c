...
static inline ALfloat point32(const ALfloat *vals, ALsizei UNUSED(frac))
{ return vals[0]; }
static inline ALfloat lerp32(const ALfloat *vals, ALsizei frac)
{ return lerp(vals[0], vals[1], frac * (1.0f/FRACTIONONE)); }
static inline ALfloat fir4_32(const ALfloat *vals, ALsizei frac)
{ return resample_fir4(vals[-1], vals[0], vals[1], vals[2], frac); }


const ALfloat *Resample_copy32_C(const InterpState* UNUSED(state),
  const ALfloat *src, ALsizei UNUSED(frac), ALint UNUSED(increment),
  ALfloat *dst, ALsizei numsamples)
{
...
const ALfloat *Resample_bsinc32_C(const InterpState *state, const ALfloat *src,
...
static inline void ApplyCoeffs(ALsizei Offset, ALfloat (*Values)[2],
