...
extern void LockEffectsRead(ALCdevice *device);
extern void UnlockEffectsRead(ALCdevice *device);
extern void LockEffectsWrite(ALCdevice *device);
extern void UnlockEffectsWrite(ALCdevice *device);
