...
enum DevFmtType {
    ...
    DevFmtTypeDefault = DevFmtShort //by stone, simulator android 16bits pcm
};
enum DevFmtChannels {
...
extern size_t RoundUp(size_t value, size_t r);
extern ALint fastf2i(ALfloat f);
extern ALuint fastf2u(ALfloat f);
extern ALsizei FrameSizeFromDevFmt(enum DevFmtChannels chans, enum DevFmtType type, ALsizei ambiorder);
extern ALint GetChannelIndex(const enum Channel names[MAX_OUTPUT_CHANNELS], enum Channel chan);
