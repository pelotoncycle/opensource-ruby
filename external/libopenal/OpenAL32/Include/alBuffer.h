...
extern ALsizei FrameSizeFromUserFmt(enum UserFmtChannels chans, enum UserFmtType type);
extern ALsizei FrameSizeFromFmt(enum FmtChannels chans, enum FmtType type);
extern void LockBuffersRead(ALCdevice *device);
extern void UnlockBuffersRead(ALCdevice *device);
extern void LockBuffersWrite(ALCdevice *device);
extern void UnlockBuffersWrite(ALCdevice *device);
