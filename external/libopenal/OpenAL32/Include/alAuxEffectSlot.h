...
struct ALeffectStateVtable {
    ...
    void (*const process)(ALeffectState *state, ALuint samplesToDo, const ALfloat (*samplesIn)[BUFFERSIZE], ALfloat (*samplesOut)[BUFFERSIZE], ALuint numChannels);
...
DECLARE_THUNK4(T, ALeffectState, void, process, ALuint, const ALfloatBUFFERSIZE*, ALfloatBUFFERSIZE*, ALuint) \
...
extern void LockEffectSlotsRead(ALCcontext *context);
extern void UnlockEffectSlotsRead(ALCcontext *context);
extern void LockEffectSlotsWrite(ALCcontext *context);
extern void UnlockEffectSlotsWrite(ALCcontext *context);
