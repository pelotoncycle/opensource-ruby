...
extern void LockSourcesRead(ALCcontext *context);
extern void UnlockSourcesRead(ALCcontext *context);
extern void LockSourcesWrite(ALCcontext *context);
extern void UnlockSourcesWrite(ALCcontext *context);
