...
extern int althrd_create(althrd_t *thr, althrd_start_t func, void *arg);
extern int althrd_detach(althrd_t thr);
extern int althrd_join(althrd_t thr, int *res);
extern void althrd_setname(althrd_t thr, const char *name);

extern int almtx_init(almtx_t *mtx, int type);
extern void almtx_destroy(almtx_t *mtx);
extern int almtx_timedlock(almtx_t *mtx, const struct timespec *ts);

extern int alcnd_init(alcnd_t *cond);
extern int alcnd_signal(alcnd_t *cond);
extern int alcnd_broadcast(alcnd_t *cond);
extern int alcnd_wait(alcnd_t *cond, almtx_t *mtx);
extern int alcnd_timedwait(alcnd_t *cond, almtx_t *mtx, const struct timespec *time_point);
extern void alcnd_destroy(alcnd_t *cond);

extern int altss_create(altss_t *tss_id, altss_dtor_t callback);
extern void altss_delete(altss_t tss_id);

extern int altimespec_get(struct timespec *ts, int base);

extern void al_nssleep(unsigned long nsec);
