...
static struct console *uart_console_driver = NULL;
...
#else
		if ((printk_disable_uart || console_suspended) && (con == uart_console_driver))
#endif
            continue;
...
void register_console(struct console *newcon)
{
	...
	if (newcon->name && (strcmp(newcon->name, "ttyMT") == 0)) {
		uart_console_driver = newcon;
	}
