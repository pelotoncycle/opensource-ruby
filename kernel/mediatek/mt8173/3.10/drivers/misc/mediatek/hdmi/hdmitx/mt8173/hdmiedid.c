...
void vShowEdidInformation(void)
{
	...
	if (u4Res & SINK_2160P_23_976HZ)
		printk("[HDMI]4k2k support to SINK_2160P_23_976HZ\n");
	if (u4Res & SINK_2160P_24HZ)
		printk("[HDMI]4k2k support to SINK_2160P_24HZ\n");
	if (u4Res & SINK_2160P_25HZ)
		printk("[HDMI]4k2k support to SINK_2160P_25HZ\n");
	if (u4Res & SINK_2160P_29_97HZ)
		printk("[HDMI]4k2k support to SINK_2160P_29_97HZ\n");
	if (u4Res & SINK_2160P_30HZ)
		printk("[HDMI]4k2k support to SINK_2160P_30HZ\n");
	if (u4Res & SINK_2161P_24HZ)
		printk("[HDMI]4k2k support to SINK_2161P_24HZ\n");
	...
	if (_HdmiSinkAvCap.b_sink_SCDC_present == TRUE)
		printk("[HDMI]HDMI_SCDC_Present\n");

	if (_HdmiSinkAvCap.b_sink_LTE_340M_sramble == TRUE)
		printk("[HDMI]LTE_340M_sramble\n");
